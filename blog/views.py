...
def home(request):
    ...
    return render(request, "home.html", {"blogs": blogs, "placeholder": homeStartingContent})
...
def about(request):
    ...
    return render(request, "about.html", {"placeholder": aboutContent})
...
def contact(request):
    ...
    return render(request, "contact.html", {"placeholder": contactContent})
...
def add(request):
    ...
    new_blog = Blog(title = request.POST["postTitle"], content = request.POST["postBody"])
    new_blog.save()
